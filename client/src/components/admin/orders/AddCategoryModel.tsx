...
import { createCategory, getAllCategory } from "../categories/FetchApi";
  ...
  const submitForm = async (e) => {
    ...
    try {
      ...
      if (responseData.success) {
        ...
        setFdata({ ...fData, success: "", error: responseData.error });
        dispatch({ type: "loading", payload: false });
        setTimeout(() => {
          return setFdata({ ...fData, error: "", success: "" });
        }, 2000);
      }
    } catch (error) {
      console.log(error);
